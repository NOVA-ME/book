...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-04-kilometers-alias/src/main.rs:2}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-04-kilometers-alias/src/main.rs:2:7}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:2:4}}
    // --snip--
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:5:7}}
    // --snip--
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:9}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:2:6}}
    // --snip--
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:7:9}}
    // --snip--
{{#include ../examples/ch19-advanced-features/listing-19-24/src/main.rs:11}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-05-write-trait/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-06-result-alias/src/lib.rs:3}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-06-result-alias/src/lib.rs:5:11}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-07-never-type/src/lib.rs:1}}
    // --snip--
{{#include ../examples/ch19-advanced-features/no-listing-07-never-type/src/lib.rs:1}}
```
...
```rust
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-05/src/main.rs:20:23}}
```
...
{{#include ../examples/ch19-advanced-features/no-listing-08-match-arms-different-types/src/main.rs:3:6}}
```
...
```rust,ignore
{{#include ../examples/ch19-advanced-features/no-listing-09-unwrap-definition/src/lib.rs:8:15}}
```
...
```rust,ignore
{{#include ../examples/ch19-advanced-features/no-listing-10-loop-returns-never/src/main.rs:2:6}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch19-advanced-features/no-listing-11-cant-create-str/src/main.rs:2:3}}
```
...
```rust,ignore
{{#include ../examples/ch19-advanced-features/no-listing-12-generic-fn-definition/src/lib.rs:1}}
    // --snip--
{{#include ../examples/ch19-advanced-features/no-listing-12-generic-fn-definition/src/lib.rs:2}}
```

is actually treated as though we had written this:

```rust,ignore
{{#include ../examples/ch19-advanced-features/no-listing-13-generic-implicit-sized-bound/src/lib.rs:1}}
    // --snip--
{{#include ../examples/ch19-advanced-features/no-listing-13-generic-implicit-sized-bound/src/lib.rs:2}}
```
...
{{#include ../examples/ch19-advanced-features/no-listing-14-generic-maybe-sized/src/lib.rs:1}}
    // --snip--
{{#include ../examples/ch19-advanced-features/no-listing-14-generic-maybe-sized/src/lib.rs:2}}
```

...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-12/src/lib.rs}}
```
...
```rust,ignore
{{#include ../examples/ch13-functional-features/listing-13-21/src/lib.rs:11:14}}
        // --snip--
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-13/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-14/src/main.rs}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-15/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-16/src/main.rs:1:27}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-17/src/main.rs:29:32}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-18/src/main.rs:29:34}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-19/src/main.rs}}
```
...
{{#include ../examples/ch19-advanced-features/listing-19-20/src/main.rs:19:21}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-21/src/main.rs:19:21}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-22/src/main.rs:1:13}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-02-impl-outlineprint-for-point/src/main.rs:15:20}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/no-listing-03-impl-display-for-point/src/main.rs:20:26}}
```
...
```rust
{{#include ../examples/ch19-advanced-features/listing-19-23/src/main.rs}}
```
